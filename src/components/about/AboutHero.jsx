    ...
    >
      <div className={styles.heroContent}>
        ...
        <p className={styles.lead}>
          Full-stack engineer focused on fast, accessible web experiences. I
          enjoy turning ambiguous product goals into maintainable systems, clear
          UI, and measurable outcomes.
        </p>
      ...
      <div className={styles.heroVisual}>
        ...
        <div className={styles.statPills}>
          ...
          <span className={styles.statPill}>Freelance friedly</span>
        </div>
      </div>
    </Motion.section>
  );
